...
class ForwardVelocityTuner extends OpMode {
    ...
    public void loop() {
        ...
        if (!end) {
            ...
            telemetryM.debug("\n");
            telemetryM.debug("Press s to set the Forward Velocity temporarily (while robot remains on).");
...
class LateralVelocityTuner extends OpMode {
    ...
    public void loop() {
        ...
        if (!end) {
            ...
            telemetryM.debug("\n");
            telemetryM.debug("Press s to set the Lateral Velocity temporarily (while robot remains on).");
            telemetryM.update(telemetry);
...
class ForwardZeroPowerAccelerationTuner extends OpMode {
    ...
    public void loop() {
        ...
        if (!end) {
            ...
            telemetryM.debug("\n");
            telemetryM.debug("Press s to set the Forward Zero Power Acceleration temporarily (while robot remains on).");
            telemetryM.update(telemetry);
...
class LateralZeroPowerAccelerationTuner extends OpMode {
    ...
    public void loop() {
        ...
        if (!end) {
            ...
            telemetryM.debug("\n");
            telemetryM.debug("Press s to set the Lateral Zero Power Acceleration temporarily (while robot remains on).");
            telemetryM.update(telemetry);
